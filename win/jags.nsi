!define APP_NAME "JAGS-vonmises"
!define PUBLISHER "JAGS-vonmises"

;Name used for JAGS VonMises module registry keys
...
!define UNINSTALL_LOG "Uninstall-vonmises"
...
Section #Default section
   ...
   WriteRegStr ${INSTDIR_REG_ROOT} "${INSTDIR_REG_KEY}" "URLInfoAbout" ""
...
Section "32-bit installation" Sec32
   ...
   File /r inst32\lib\JAGS\modules-${MAJOR}\vonmises*
...
Section "64-bit installation" Sec64
   ...
   !insertmacro UNINSTALL.LOG_OPEN_INSTALL
   File /r inst64\lib\JAGS\modules-${MAJOR}\vonmises*
   !insertmacro UNINSTALL.LOG_CLOSE_INSTALL
